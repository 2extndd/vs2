...
def should_exclude_item(item, exclude_catalog_ids):
    ...
    if is_excluded:
        logging.info(f"🚫 Item excluded: catalog_id={item_catalog_id} in exclude_list={exclude_list}")
    else:
        logging.debug(f"✅ Item allowed: catalog_id={item_catalog_id} not in exclude_list={exclude_list}")
